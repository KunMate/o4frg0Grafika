...
void handle_app_events(App* app, int collected)
{
    SDL_Event event;
        ...
        case SDL_KEYDOWN:
            ...
            case SDL_SCANCODE_ESCAPE:
                ...
                case SDL_SCANCODE_W:
                    ...
                    break;
                case SDL_SCANCODE_LSHIFT: // majd ugy csinald meg hogy a camera speedet vizsgalod
                if(collected == 1) {
                    curspeed = app->camera.speed.y;
                    if (curspeed == 1.5) {
                        set_camera_speed(&(app->camera), curspeed * 1.8);
                    }
                }
                    break;
                case SDL_SCANCODE_S:
                ...
                case SDL_SCANCODE_SPACE:
                    if(app->camera.speed.z == 0) {
                        set_camera_jump_speed(&(app->camera), speed);
                    }
                    break;
                case SDL_SCANCODE_E:
